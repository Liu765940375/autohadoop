...
def deploy_tpcds_kit(custom_conf, master, slaves):
    ...
    replace_tpcds_kit_package(slaves, TPCDS_KIT_COMPONENT, tpcds_kit_home, tpcds_kit_version )
...
def replace_tpcds_kit_package(slaves, component, tpcds_kit_home, version):
    ...
    os.system("cp -r " + tpcds_kit_home + "-" + version + ".tar.gz " + package_path)
